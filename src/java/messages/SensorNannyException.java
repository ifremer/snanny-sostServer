...
/** Web application Exception class for SOS server
 *
 * @author mlarour
 */
public class SensorNannyException extends WebApplicationException
{
     ...
     */
    public SensorNannyException(String message,Status status)
    {
        super(status);
