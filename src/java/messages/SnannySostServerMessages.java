 ...
 * @author mlarour
 */
public class SnannySostServerMessages
{   
    // 
...
// uuid between 1of2 and 2of2
    ...
    public static String ERROR_PROPERTIES                    = "Can't get snanny-sostServer properties";
    public static String ERROR_PROPERTIES_DATA_CONFIGURATION = "Unknown configuration for data in snanny-sostServer properties";
    public static String ERROR_PROPERTIES_XML_EXTENSION      = "Unknown configuration for xml extension in snanny-sostServer properties";
    public static String ERROR_PROPERTIES_XML_CHARSET        = "Unknown configuration for charset in snanny-sostServer properties";
    public static String ERROR_PROPERTIES_SENSOR_ML_XSD      = "Unknown configuration for SemsorML xsd in snanny-sostServer properties";
    public static String ERROR_PROPERTIES_OEM_XSD            = "Unknown configuration for O&M xsd in snanny-sostServer properties";
    public static String ERROR_PROPERTY_STORAGE              = "Unknown configuration for Storage in snanny-sostServer properties";    
    public static String ERROR_PROPERTY_JSON                 = "Unknown configuration for Json in snanny-sostServer properties";    
    public static String ERROR_PROPERTY_COUCHBASE_HOST               = "Unknown configuration for Couchbase Host in snanny-sostServer properties";
    public static String ERROR_PROPERTY_COUCHBASE_PASSWD             = "Unknown configuration for Couchbase Passwd in snanny-sostServer properties";
    public static String ERROR_PROPERTY_COUCHBASE_SYSTEM_BUCKET      = "Unknown configuration for Couchbase System Bucket in snanny-sostServer properties";
    public static String ERROR_PROPERTY_COUCHBASE_OBSERVATION_BUCKET = "Unknown configuration for Couchbase Observation Bucket in snanny-sostServer properties";            
    public static String ERROR_PROPERTY_COUCHBASE_TIME_OUT_MS        = "Unknown configuration for Couchbase time out in snanny-sostServer properties";
    public static String ERROR_PROPERTY_SQUID_HOST                   = "Unknown configuration for Squid host in snanny-sostServer properties";
    public static String ERROR_PROPERTY_SQUID_PORT                   = "Unknown configuration for Squid port in snanny-sostServer properties";
    
    
    // errors
    public static String ERROR_XML_CHARSET                   = "Unknown charset in snanny-sostServer properties";    
    public static String ERROR_DATA_DIRECTORY                = "Directory expected for data in snanny-sostServer properties";
    ...
    public static String ERROR_OEM_XSL                       = "O&M as xsl for SensorML is not valid";
    public static String ERROR_OEM_XSL_VALIDATION            = "O&M is not valid for Schematron as xsl : ";
    ...
    // couchbase errors
    public static String ERROR_COUCHBASE_DISCONNECT          = "Couchbase disconnect error ";
    public static String ERROR_COUCHBASE_ERROR               = "Couchbase error ";
    public static String ERROR_COUCHBASE_deleteSensor        = "Couchbase error,  delete Sensor failed";
    public static String ERROR_COUCHBASE_deleteObservation   = "Couchbase error,  delete Observation failed";
